...
const simplex2 = Fn(([p]) => {
  ...
  return contrib2(d0, hash2u(i, j))
    .add(contrib2(d1, hash2u(i.add(i1), j.add(j1))))
    .add(contrib2(d2, hash2u(i.add(1), j.add(1))))
})
...
const simplex3 = Fn(([p]) => {
  ...
  return contrib3(d0, hash3u(i, j, k))
    .add(contrib3(d1, hash3u(i.add(i1), j.add(j1), k.add(k1))))
    .add(contrib3(d2, hash3u(i.add(i2), j.add(j2), k.add(k2))))
    .add(contrib3(d3, hash3u(i.add(1), j.add(1), k.add(1))))
})
`
